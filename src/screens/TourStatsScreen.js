...
const styles = StyleSheet.create({
  ...
  pairStatVals: { flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap' },
  pairStatP1: { fontSize: 15, fontWeight: '700' },
  pairStatP2: { fontSize: 15, fontWeight: '700' },
  pairStatDash: { color: '#888', fontSize: 15 },
  pairStatSingle: { color: '#e8e8e8', fontSize: 14, fontWeight: '600' },
});
